...
public class IPSeeker {
    ...
    private IPSeeker() {
        ...
        b3 = new byte[3];
        try {
            ipFile = new RandomAccessFile(new File(IPSeeker.class.getResource("qqwry.dat").getFile()), "r");
    ...
    public static void main(String[] args){
        String ip = "58.18.169.24";
        System.out.println(IPSeeker.getInstance().getAddress(ip));
        System.out.println(IPSeeker.getInstance().getArea(ip));
        System.out.println(IPSeeker.getInstance().getCountry(ip));
    }
}