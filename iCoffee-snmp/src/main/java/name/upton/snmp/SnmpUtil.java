...
public class SnmpUtil {
    ...
    public static CommunityTarget createMyDefaultTarget(String address, String community) {
        return createCommunityTarget(address, community, DEFAULT_VERSION, DEFAULT_TIMEOUT, DEFAULT_RETRY);
    }
     ...
     * @return CommunityTarget
     */
    public static CommunityTarget createCommunityTarget(String address, String community, int version) {
        return createCommunityTarget(address, community, version, DEFAULT_TIMEOUT, DEFAULT_RETRY);
    }
     ...
     * @return UserTarget
     */
    public static UserTarget createUserTarget(Address targetAddress, int version, long timeOut, int level, String securityName) {
